    ...
    this.initGenericResponseTypeList(val, {
      mappings: [
        ...
        },
        {
          ...
          statisticTypes: [MemoryStatisticType.MALLOC],
          normalTypes: [`'${MemoryType.MEMORY_M_ALLOC_NAME}'`]
        },
        {
        ...
        {
          selectionKey: MemoryBasicType.NATIVE_MEMORY[5], // KMP Heap
          statisticTypes: [MemoryStatisticType.KMP],
          normalTypes: [`'${MemoryType.KMP_Alloc_NAME}'`]
        },
        {
          selectionKey: MemoryBasicType.NATIVE_MEMORY[6], // All Anonymous VM (泳道组)
          statisticTypes: [
            MemoryStatisticType.MMAP,
            MemoryStatisticType.FILE_PAGE_MSG,
            MemoryStatisticType.MEMORY_USING_MSG,
    ...
    for (let applySample of typeMap.get(tyeId)!) {
      ...
      switch (this.memoryType) {
        case MemoryTraceRowType.ROW_TYPE_NATIVE_MEMORY:
          ...
          if ([MemoryStatisticType.MALLOC, MemoryStatisticType.MMAP, MemoryStatisticType.FILE_PAGE_MSG, MemoryStatisticType.MEMORY_USING_MSG, MemoryStatisticType.ARKTS, MemoryStatisticType.JS,
          MemoryStatisticType.KMP, MemoryStatisticType.DMA, MemoryStatisticType.ASHMEM,
