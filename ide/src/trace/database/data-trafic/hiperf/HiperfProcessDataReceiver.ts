...
export const chartHiperfProcessData10MSProtoSql = (args: any): string => {
...
export const chartHiperfProcessDataProtoSql = (args: any): string => {
...
export function hiperfProcessDataReceiver(data: any, proc: Function): void {
  let sql: string;
