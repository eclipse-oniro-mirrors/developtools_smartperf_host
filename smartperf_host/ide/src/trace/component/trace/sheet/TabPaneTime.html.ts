...
export const ClassifyCoreSettingHtml = `
    ...
    <lit-table id="tb-core-parallel" style="height: auto" tree >
        ...
        <lit-table-column class="freqtree-sample-column" width="1fr" title="Running dur(ms)" data-index="dur" key="dur" align="flex-start" >
        </lit-table-column>
        <lit-table-column class="freq-sample-column" width="1fr" title="T parallel num" data-index="parallelNum" key="parallelNum" align="flex-start" >
        </lit-table-column>
        <lit-table-column class="freq-sample-column" width="1fr" title="Parallel dur(ms)" data-index="parallelDur" key="parallelDur" align="flex-start" >
    ...
    <tab-pane-filter id="filter" cpu_config></tab-pane-filter>
`;