...
constexpr uint64_t ALLOC_IP_MASK = 0xFFFFFF0000000000;
constexpr uint64_t JS_IP_MASK = 0xFFFFFE0000000000;
class FrameInfo {
public:
    FrameInfo()
    {
...
protected:
    ...
    DoubleMap<uint32_t/* ipid */, uint32_t/* file_path_id */, uint64_t/* adltbase */> ipidToFilePathIdToAdltBase_;
