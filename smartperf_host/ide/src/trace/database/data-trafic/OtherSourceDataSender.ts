...
export function otherSourceSender( //@ts-ignore
...
export function otherSourceChartDataCacheSender(processes: Array<number>, model: string): Promise<unknown> {
  return new Promise((resolve, reject) => {
    threadPool.submitProto(
      model === 'native_hook' ? QueryEnum.otherSourceCacheNormal : QueryEnum.otherSourceCacheStatistic,
      {
