...
private:
    ...
    {
        return dataCache_->GetConstCpuMeasuresData().Size();
    }
    void GetOrbyes(FilterConstraints &cpufc, EstimatedIndexInfo &cpuei) override;
    void FilterByConstraint(FilterConstraints &cpufc,
