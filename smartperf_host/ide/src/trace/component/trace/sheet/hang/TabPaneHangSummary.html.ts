...
export const TabPaneHangSummaryHtml = `<style>
        :host{
          padding: 10px 10px;
          display: flex;
        ...
        <div class="tab-summary-head">
          <div style="justify-content: flex-start; display: flex">
            ...
            <label class="head-label" style="cursor: pointer;">/Hang</label>
          </div>
          <label class="head-count">Count</label> 
        </div>
        <div id="tab-summary" style="overflow: auto;display: grid; grid-template-columns: 80% 15%;"></div>
        <lit-table id="tb-hang-summary" style="display: none" tree>
          <lit-table-column title="Type/Process/Hang" data-index="hangName" key="hangName"></lit-table-column>
