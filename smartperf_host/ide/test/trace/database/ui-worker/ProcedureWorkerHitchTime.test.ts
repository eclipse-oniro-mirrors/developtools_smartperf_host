...
import { HitchTimeStruct, hitchTimeRender } from '../../../../src/trace/database/ui-worker/ProcedureWorkerHitchTime';
...
describe('ProcedureWorkerHitchTime Test', () => {
  ...
  it('ProcedureWorkerHitchTimeTest01 ', function () {
    ...
    expect(HitchTimeStruct.draw(ctx, data)).toBeUndefined();
  });
  it('ProcedureWorkerHitchTimeTest02 ', function () {
    ...
    expect(hitchRender.renderMainThread(hitchReq,new TraceRow())).toBeUndefined()
  });
});
