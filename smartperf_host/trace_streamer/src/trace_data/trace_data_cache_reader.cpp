...
const TimerfdWakeup &TraceDataCacheReader::GetConstTimerfdWakeupData() const
{
    return timerfdWakeupData_;
}

const FileSystemIo &TraceDataCacheReader::GetConstFileSystemIoData() const
{
    return fileSystemIoData_;
}
