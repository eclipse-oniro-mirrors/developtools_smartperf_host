...
:host([basicMemory]) .popover .tree-check:nth-child(3){
  display:none;
}
:host([basicMemory]) .popover .tree-check:nth-child(5){
  display:none;
}
:host([basicMemory]) .popover .tree-check:nth-child(6){
    display:none;
  }
:host([isStatistics]) .popover .tree-check:nth-child(4){
  display:none;
}
:host(:not([mark])) #mark{
    display: none;
