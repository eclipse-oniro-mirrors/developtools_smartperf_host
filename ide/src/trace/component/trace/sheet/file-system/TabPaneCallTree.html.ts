    ...
    <selector id='show_table' class="show">
        ...
        <div id="left_table" style="width: 65%">
            <lit-table id="tb-calltree" style="height: auto" tree>
                <lit-table-column class="call-tree-column" width="70%" title="Call Stack" data-index="symbol" key="symbol"  align="flex-start" retract></lit-table-column>
        ...
        <lit-table id="tb-list" no-head style="height: auto;border-left: 1px solid var(--dark-border1,#e2e2e2)" hideDownload>
            ...
            <lit-table-column class="call-tree-column" width="1fr" title="" data-index="symbol" key="symbol"  align="flex-start"></lit-table-column>
        </lit-table>
        </div>
        </lit-slicer>
     </selector>
