    ...
    <selector id='show_table' class="show">
        ...
        <div id="left_table" style="width: 65%">
            ...
            <lit-table id="tb-filesystem-calltree" style="height: auto" tree>
                ...
                <lit-table-column class="nm-call-tree-column" width="1fr" title="Count" 
     ...
     <tab-pane-filter id="nm-call-tree-filter" first second icon basicMemory></tab-pane-filter>
