...
class PbreaderJSMemoryParser : public EventParserBase, public HtracePluginTimeParser {
public:
    PbreaderJSMemoryParser(TraceDataCache *dataCache, const TraceStreamerFilters *ctx);
    ~PbreaderJSMemoryParser();
