...
- Record Cpu Memory：抓取cpu内存。
- Record Gpu Memory：抓取gpu内存。
...
-     All Heap&Anonymous VM：malloc、globalhandle、localhandle、arktsHeap、jsHeap、kmpHeap分配和mmap、dma、so、ashmem分配的总量。
-     All Heap：malloc、globalhandle、localhandle、arktsHeap、jsHeap、kmpHeap分配的内存。
-     All Anonymous VM：mmap、dma、so、ashmem分配的内存。
-     Native Heap：malloc、globalhandle、localhandle分配的内存。
