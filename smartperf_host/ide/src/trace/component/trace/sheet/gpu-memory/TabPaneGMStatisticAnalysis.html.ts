...
export const TabPaneGMStatisticAnalysisHtml = `
        <style>
        :host {
        ...
        <div style="display: flex;flex-direction: row;" class="d-box">
            <lit-progress-bar class="gm-progress"></lit-progress-bar>
            <div id="left_table" style="width: 40%; height:auto;">
                <div style="display: flex; margin-bottom: 10px">
                    <div class="gm-go-back">
                        <div class="gm-back-box">
                            <lit-icon name="arrowleft"></lit-icon>
                        </div>
                    </div>
                    <div class="title"></div>
                </div>
                <div class="gm-subheading"></div>
                <lit-chart-pie  id="gm-chart-pie"></lit-chart-pie>
            </div>
            <div class="gm-table-box" style="height:auto;">
                <lit-table id="tb-eventtype-usage">
                    ...
                    data-index="existSizeFormat" key="existSizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="event-class" title="%" 
                    data-index="existSizePercent" key="existSizePercent" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="event-class" title="# Existing" 
                    ...
                    <lit-table-column width="100px" class="event-class" title="Total Bytes" 
                    data-index="applySizeFormat" key="applySizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="event-class" title="%" 
                    data-index="applySizePercent" key="applySizePercent" align="flex-start" order></lit-table-column>
                    ...
                    data-index="releaseSizeFormat" key="releaseSizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="event-class" title="%" 
                    data-index="releaseSizePercent" key="releaseSizePercent" align="flex-start" order>
                    </lit-table-column>
                    <lit-table-column width="100px" class="event-class" title="# Transient" 
                ...
                <lit-table id="tb-thread-usage" style="display: none;" hideDownload>
                    ...
                    data-index="tableName" key="tableName" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="thread-class" title="Existing" 
                    data-index="existSizeFormat" key="existSizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="thread-class" title="%" data-index="existSizePercent" 
                    key="existSizePercent" align="flex-start" order></lit-table-column>
                    ...
                    <lit-table-column width="100px" class="thread-class" title="Total Bytes" 
                    data-index="applySizeFormat" 
                    key="applySizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="thread-class" title="%" data-index="applySizePercent" 
                    key="applySizePercent" align="flex-start" order></lit-table-column>
                    ...
                    <lit-table-column width="100px" class="thread-class" title="Transient" 
                    data-index="releaseSizeFormat" 
                    key="releaseSizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="thread-class" title="%" data-index="releaseSizePercent" 
                    key="releaseSizePercent" align="flex-start" order></lit-table-column>
                ...
                <lit-table id="tb-so-usage" style="display: none;" hideDownload>
                    ...
                    <lit-table-column width="100px" class="so-class" title="Existing" data-index="existSizeFormat" 
                    key="existSizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="so-class" title="%" data-index="existSizePercent" 
                    key="existSizePercent" align="flex-start" order></lit-table-column>
                    ...
                    key="existCountPercent" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="so-class" title="Total Bytes" data-index="applySizeFormat" 
                    key="applySizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="so-class" title="%" data-index="applySizePercent" 
                    key="applySizePercent" align="flex-start" order></lit-table-column>
                    ...
                    key="applyCountPercent" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="so-class" title="Transient" data-index="releaseSizeFormat" 
                    key="releaseSizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="so-class" title="%" data-index="releaseSizePercent" 
                    key="releaseSizePercent" align="flex-start" order></lit-table-column>
                ...
                <lit-table id="tb-function-usage" style="display: none;" hideDownload>
                    ...
                    key="tableName" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="function-class" title="Existing" 
                    data-index="existSizeFormat" 
                    key="existSizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="function-class" title="%" data-index="existSizePercent" 
                    key="existSizePercent" align="flex-start" order></lit-table-column>
                    ...
                    key="existCountPercent" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="function-class" title="Total Bytes" 
                    data-index="applySizeFormat" 
                    key="applySizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="function-class" title="%" data-index="applySizePercent" 
                    key="applySizePercent" align="flex-start" order></lit-table-column>
                    ...
                    data-index="releaseSizeFormat" 
                    key="releaseSizeFormat" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="function-class" title="%" data-index="releaseSizePercent" 
                    key="releaseSizePercent" align="flex-start" order></lit-table-column>
                    <lit-table-column width="100px" class="function-class" title="# Transient" 
