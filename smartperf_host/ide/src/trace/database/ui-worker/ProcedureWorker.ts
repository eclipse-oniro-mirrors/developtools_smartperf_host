...
import { GpuMemoryRender } from './ProcedureWorkerGpuMemory';
import { OtherSourceRender } from './ProcedureWorkerOtherSource';
...
export let renders = {
  ...
  heap: new HeapRender(),
  gpuMemory: new GpuMemoryRender(),
  otherSource: new OtherSourceRender(),
