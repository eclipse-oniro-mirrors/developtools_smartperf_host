...
import { IOStructOnClick, IOStruct } from '../database/ui-worker/ProcedureWorkerIO';
import { SlicesTime } from './trace/timer-shaft/SportRuler';
...
function allStructOnClick(clickRowType: string, sp: SpSystemTrace, row?: TraceRow<BaseStruct>, entry?: unknown): void {
  CpuStructOnClick(clickRowType, sp, cpuClickHandlerFunc(sp), entry as CpuStruct)
    ...
    .then(() => IOStructOnClick(clickRowType, sp, entry as IOStruct))
    .then(() => {
