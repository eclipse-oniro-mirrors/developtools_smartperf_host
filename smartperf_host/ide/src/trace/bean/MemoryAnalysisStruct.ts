  ...
  private nativeMemoryInit(type: number | string): void {
    switch (type) {
      ...
      case MemoryStatisticType.MALLOC:
        ...
        break;
      case MemoryType.ARK_GLOBAL_HANDLE_Alloc_NAME:
      case MemoryStatisticType.ARK_GLOBAL_HANDLE:
        this.type = 17;
        this.typeName = MemoryType.ARK_GLOBAL_HANDLE_Alloc_NAME;
        this.isRelease = false;
        break;
      case MemoryType.ARK_LOCAL_HANDLE_Alloc_NAME:
      case MemoryStatisticType.ARK_LOCAL_HANDLE:
        this.type = 18;
        this.typeName = MemoryType.ARK_LOCAL_HANDLE_Alloc_NAME;
        this.isRelease = false;
        break;
      ...
      case MemoryStatisticType.JS:
        ...
        this.isRelease = false;
        break;
      case MemoryType.DART_HEAP_Alloc_NAME:
      case MemoryStatisticType.DART_HEAP:
        this.type = 20;
        this.typeName = MemoryType.DART_HEAP_Alloc_NAME;
        this.isRelease = false;
        break;
      case MemoryType.ARKTS_STATIC_HEAP_Alloc_NAME:
      case MemoryStatisticType.ARKTS_STATIC_HEAP:
        this.type = 21;
        this.typeName = MemoryType.ARKTS_STATIC_HEAP_Alloc_NAME;
        this.isRelease = false;
        break;
      case MemoryType.RN_HERMES_HEAP_Alloc_NAME:
      case MemoryStatisticType.RN:
        this.type = 13;
        this.typeName = MemoryType.RN_HERMES_HEAP_Alloc_NAME;
        this.isRelease = false;
        break;
      ...
      case MemoryType.ASHMEM_Free_NAME:
        ...
        this.type = 14;
        break;
      case MemoryType.DART_HEAP_Free_NAME:
        this.type = 20;
        this.typeName = MemoryType.DART_HEAP_Free_NAME;
        this.isRelease = true;
        break;
      case MemoryType.ARKTS_STATIC_HEAP_Free_NAME:
        this.type = 21;
        this.typeName = MemoryType.ARKTS_STATIC_HEAP_Free_NAME;
        this.isRelease = true;
        break;
      case MemoryType.RN_HERMES_HEAP_Free_NAME:
        this.type = 13;
        this.typeName = MemoryType.RN_HERMES_HEAP_Free_NAME;
        this.isRelease = true;
        break;
      case MemoryType.ARK_GLOBAL_HANDLE_Free_NAME:
        this.isRelease = true;
        this.typeName = MemoryType.ARK_GLOBAL_HANDLE_Free_NAME;
        this.type = 17;
        break;
      case MemoryType.ARK_LOCAL_HANDLE_Free_NAME:
        this.isRelease = true;
        this.typeName = MemoryType.ARK_LOCAL_HANDLE_Free_NAME;
        this.type = 18;
        break;
      default:
        this.isRelease = false;
