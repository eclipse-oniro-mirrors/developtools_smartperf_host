...
private:
    ...
    void ParseHtraceCommDict(ProtoReader::TracePluginResult_Reader &tracePluginResult);
    void ParseHtraceCpuStats(ProtoReader::TracePluginResult_Reader &tracePluginResult, PbreaderDataSegment &dataSeg);
#endif
#ifdef ENABLE_FFRT
