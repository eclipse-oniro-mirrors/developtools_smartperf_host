...
import { TabPaneGMStatisticAnalysis } from '../sheet/gpu-memory/TabPaneGMStatisticAnalysis';
import { TabpaneGMCalltree } from '../sheet/gpu-memory/TabpaneGMCalltree';
import { TabPaneGMStatstics } from '../sheet/gpu-memory/TabPaneGMStatstics';
import { TabPaneGMemory } from '../sheet/gpu-memory/TabPaneGMemory';
import { TabPaneGMSampleList } from '../sheet/gpu-memory/TabPaneGMSampleList';
import { TabPaneOSAnalysis } from '../sheet/otherSource/TabPaneOSAnalysis';
import { TabpaneOSCalltree } from '../sheet/otherSource/TabpaneOSCalltree';
import { TabPaneOSEvents } from '../sheet/otherSource/TabPaneOSEvents';
import { TabPaneFreqByCpu } from '../sheet/cpu/TanpaneFreqByCpu';
import { TabPaneSchedTaskByCpu } from '../sheet/cpu/TabPaneSchedTaskByCpu';
...
export let tabConfig: {
  ...
  'box-frpq-by-cpu': {
    title: 'CPU Freq Usage',
    type: TabPaneFreqByCpu,
    require: (param: SelectionParam) => param.cpus.length > 0,
  },
  'box-spt': {
  ...
  'box-gpu-statstics': {
    ...
    type: TabPaneGMStatstics,
    require: (param: SelectionParam) => param.gpuMemory.length > 0,
  },
  'box-gpu-statistic-analysis': {
    title: 'Gpu Analysis',
    type: TabPaneGMStatisticAnalysis,
    require: (param: SelectionParam) => param.gpuMemory.length > 0 || param.gpuMemoryStatistic.length > 0,
  },
  'box-gpu-calltree': {
    title: 'Gpu Calltree',
    type: TabpaneGMCalltree,
    require: (param: SelectionParam) => param.gpuMemory.length > 0 || param.gpuMemoryStatistic.length > 0,
  },
  'box-gpu-memory': {
    title: 'Gpu Memory',
  ...
  'box-gpu-sample': {
    title: 'Gpu SnapshotList',
    type: TabPaneGMSampleList,
    require: (param: SelectionParam) => param.gpuMemory.length > 0,
  },
  'box-other-source-analysis': {
    title: 'Othersource Analysis',
    type: TabPaneOSAnalysis,
    require: (param: SelectionParam) => param.otherSource.length > 0 || param.otherSourceStatistic.length > 0,
  },
  'box-os-calltree': {
    title: 'Othersource Calltree',
    type: TabpaneOSCalltree,
    require: (param: SelectionParam) => param.otherSource.length > 0 || param.otherSourceStatistic.length > 0,
  },
  'box-other-source-events':{
     title: 'Othersource Events',
    type: TabPaneOSEvents,
    require: (param: SelectionParam) => param.otherSource.length > 0,
  },
  ...
  'box-sched-task': {
    title: 'Sched Task',
    type: TabPaneSchedTaskByCpu,
    require: (param: SelectionParam) => param.cpus.length > 0 || param.threadIds.length > 0,
  },
  'tab-hisysevents': {
    title: 'HiSysevents',
  ...
  'box-io-statiics': {
    title: "IO Statistics",
    type: TabPaneIOStatistics,
    require: (param: SelectionParam) => param.ioStatisticsRowIds.length > 0 || param.ioStatiicsData.length > 0,
  }
};
